      ...
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-700 p-6 sm:p-8 mb-8">
          ...
          <div className="mb-8">
            ...
            {/* Date & Time */}
            <div className="mb-6 p-6 bg-emerald-600/10 border-2 border-emerald-500/30 rounded-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              ...
              <div className="p-4 bg-blue-600/10 border border-blue-500/30 rounded-lg">
                ...
                <p className="font-semibold text-gray-100">{bookingData.creatorName}</p>
                <p className="text-sm text-gray-300">{bookingData.creatorEmail}</p>
              </div>
              ...
              <div className="p-4 bg-purple-600/10 border border-purple-500/30 rounded-lg">
                ...
                <p className="font-semibold text-gray-100">{bookingData.bookerName}</p>
                <p className="text-sm text-gray-300">{bookingData.bookerEmail}</p>
              </div>
            </div>
            ...
            {bookingData.meetingPurpose && (
              <div className="mb-6 p-4 bg-slate-700/50 border border-slate-600 rounded-lg">
                ...
                <p className="text-gray-100">{bookingData.meetingPurpose}</p>
              </div>
            )}
            ...
            {bookingData.bookerNote && (
              <div className="p-4 bg-yellow-600/10 border border-yellow-500/30 rounded-lg">
                ...
                <p className="text-gray-100">{bookingData.bookerNote}</p>
              </div>
            )}
          </div>
        ...
        {/* What's Next Section */}
        <div className="bg-slate-800/40 backdrop-blur-sm rounded-xl border border-slate-600/50 p-6 mb-8">
          <h3 className="font-semibold text-gray-100 mb-4 flex items-center gap-2">
            <span>📋</span> What Happens Next?
          </h3>
          <ul className="space-y-3 text-sm text-gray-300">
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-emerald-600/20 text-emerald-400 rounded-full flex items-center justify-center text-xs font-bold border border-emerald-500/30">
                ✓
              </span>
              <span>
                <strong className="text-gray-200">Confirmation emails sent</strong> to both you and {bookingData.creatorName} with calendar invites (.ics files)
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-emerald-600/20 text-emerald-400 rounded-full flex items-center justify-center text-xs font-bold border border-emerald-500/30">
              ...
              <span>
                <strong className="text-gray-200">Link expired</strong> - This booking link can no longer be used
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-emerald-600/20 text-emerald-400 rounded-full flex items-center justify-center text-xs font-bold border border-emerald-500/30">
              ...
              <span>
                <strong className="text-gray-200">All data auto-deleted</strong> after 24 hours for your privacy
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong className="text-gray-200">Check your calendar</strong> - Add the meeting to your preferred calendar app using the email attachment
              </span>
            </li>
          </ul>
        </div>
