...
export default function RescheduleConfirmedPage() {
  ...
  const newMeetingDate = new Date(booking.selectedTime);
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 mb-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg font-bold text-green-900">
                    {formatInTimezone(newMeetingDate, userTimezone, 'EEEE, MMMM d, yyyy')}
                  </p>
                  <p className="text-lg text-green-900">
                    {formatInTimezone(newMeetingDate, userTimezone, 'h:mm a')} ({getTimezoneAbbr(userTimezone)})
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-sm text-green-800 text-center">
              ...
              <br />
              Both you and {booking.creatorName} will receive updated calendar invites with the new meeting time.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong className="text-gray-900">Updated emails sent</strong> to both you and {booking.creatorName} with new calendar invites
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-xs font-bold border border-green-200">
              ...
              <span>
                <strong className="text-gray-900">Old calendar event cancelled</strong> and replaced with the new time
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong className="text-gray-900">Update your calendar</strong> - Check your email for the updated calendar invite (.ics file)
              </span>
            </li>
          </ul>
        </div>
